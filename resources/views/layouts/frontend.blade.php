...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo"><img src="/assets/img/kreasi_jaya.png" alt="" class="img-fluid"></a> 
    ...
    <section id="counts" class="counts">
      <div class="container">
        ...
        <div class="text-center title">
          ...
          <p>Clients Smart Choice, Full of Hard Worker Dreamteam and Project Built To Perfection.</p>
        </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Perumahan Hamba Allah No. 134 Dapur Lamongan</p>
              </div>
